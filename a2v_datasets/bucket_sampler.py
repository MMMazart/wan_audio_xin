...
ASPECT_RATIO_627 = {
     ...
     '3.60': ([1152, 320], 1), '3.80': ([1216, 320], 1), '4.00': ([1280, 320], 1)}  # 480p
            ...
            if content_type == 'image':
                try:
                    ...
                    if width is None or height is None:
                        image_id, name = image_dict['image_path'], image_dict['text']
                ...
                try:
                    ...
                    if width is None or height is None:
                        video_id, name = video_dict['video_path'], video_dict['text']
                        if self.train_folder is None:
                            video_dir = video_id
                        else:
